...
function setGeneralTab() {
    ...
    generalTab && generalTab.addEventListener('click', function(){
...
function setAppointmentCollapse() {
    ...
    appointmentSectionTitle && appointmentSectionTitle.addEventListener('click', function(){
        unsafeWindow.console.log(`tampermonkey clicked section title`, appointmentSectionTitle.className);
        appointmentSectionTitle.className != "cp-sidebar-expandable-section undefined opened" && waitAppointmentSidebar()
    },false)
}
